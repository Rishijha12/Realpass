...
//            lblCallSms.text = "SMS, Call"
    ...
    @IBOutlet var lblDatTimeHaveNoData: UILabel!{
        didSet{
            lblDatTimeHaveNoData.font = .custom(style: .Regular, size: .s16)
            lblDatTimeHaveNoData.backgroundColor = .white
        }
    }
...
//                    self.lblYesOrNoFinance.text = self.model?.preApprovedFinance ?? ""
    ...
    func partner()
    {
        if arrPartner.count == 0
        {
            ...
            lblTablviewPartenerbg.text = "You don't have any partner yet"
            //self.partnerViewHeight.constant = 100
...
//            self.dateAndtimeViewHight.constant = CGFloat(0)
            lblDatTimeHaveNoData.text = "N/A"
            tbldateAndtime.isHidden = true
        }
        else
        {
            tbldateAndtime.isHidden = false
...
//        if abotdata == ""{
//            self.aboutviewHight.constant = 0
//            self.lblaboutmeHight.constant = 0
//            self.aboutviewTop.constant = 0
//        }else{
